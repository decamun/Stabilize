...
void setup() {
  ...
  mot_client1.AngleKp.Set(com1,0.0);

  mot_client1.AngleKi.Set(com1,0.0);
  
  mot_client1.AngleKd.Set(com1,0.0);
...
void loop() {
  ...
  float accelX = accel_event.acceleration.x;
  float accelY = accel_event.acceleration.y;
  float accelZ = accel_event.acceleration.z;
  ...
  mot_client1.CmdAngle.Set(com1,0.0);


  Serial.printf("%d,%f,%f,%f,%f,%f\n\r",millis(),accelX, accelY, accelZ, mot_client1.ObsAngle.GetReply(), mot_client1.EstMotorTorque.GetReply());
